          ...
          <div class="col-8 m-auto">
            ...
            <div class="card">
              <div class="card-header bg-purple text-white">
                <strong>Add Menu Heading</strong>
              </div>
              <div class="card-body">
                <form action="{{ url('add/menu/heading/post') }}" method="post">
                  @csrf
                  <div class="form-group">
                    <label>Menu Heading</label>
                    <textarea type="text" rows="2" name="menu_headings" class="form-control" placeholder="Write menu heading within 30 words!">{{ old('menu_headings') }}</textarea>
                    @error ('menu_headings')
                  ...
                  <button type="submit" style="cursor:pointer;" class="btn btn-info">Upload</button>
                </form>
              </div>
            </div>
          </div>
